...
import id.rezyfr.routinist.domain.usecase.GetActivitySummaryUseCase.Params
...
) : UseCase<ActivitySummaryModel, Params> {
    override suspend fun execute(params: Params): UiResult<ActivitySummaryModel> {
        val (from, to, userHabitId) = params
        ...
        return handleResult(
            ...
            onSuccess = {
                ActivitySummaryModel.fromResponse(it)
            }
        )
    }
