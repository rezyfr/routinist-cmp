...
interface HabitRepository {
    ...
    suspend fun getTodayHabitProgresses(): Result<List<HabitProgressResponse>>
    ...
    suspend fun getUserHabits(): Result<List<UserHabitResponse>>
    ...
    suspend fun getHabitStats(
        ...
        startDate: String,
        endDate: String
    ): Result<List<HabitStatsResponse>>
}